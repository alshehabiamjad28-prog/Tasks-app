...
class AddPage extends StatelessWidget {
  final AddController controller = Get.find<AddController>();
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          controller2.performview();
          controller.clearcontroller();
        },

        child: FaIcon(FontAwesomeIcons.check),
      ),
      appBar: AppBar(backgroundColor: Color(backgroundColor)),
      body: Obx(() {
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.symmetric(
                          vertical: screenPadding * 3,
                        ),
                        child: Text(
                          "Add task",
                          style: TextStyle(fontSize: headline1),
                        ),
                      ),
